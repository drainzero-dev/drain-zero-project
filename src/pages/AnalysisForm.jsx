...
const AnalysisForm = ({
    ...
    const onFinish = (values) => {
        ...
        numericFields.forEach(key => {
            if (sanitizedValues[key] === undefined || sanitizedValues[key] === null || sanitizedValues[key] === '') {
                sanitizedValues[key] = 0;
            }
        });

        console.log('Final Analysis Data:', sanitizedValues);
        message.success("Calculating precise tax impact...");
                    ...
                    <Row gutter={[24, 0]}>
                        ...
                        <Col xs={24} md={12}>
                            <Form.Item label="State" name="propertyState" rules={[{ required: true }]}>
                                <Select style={inputStyle} placeholder="Select State">
